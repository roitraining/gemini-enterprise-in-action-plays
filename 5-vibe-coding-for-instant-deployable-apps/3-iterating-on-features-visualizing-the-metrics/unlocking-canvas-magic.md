...
__Checkpoint__ You should get something similar to the screenshot below. 

   <p align="left">
     <img src="images/initial-ui.png" width="50%" alt="Cymbal Shift Handover Tool" style="border: 1px solid black;" />
     <br>
...
__Checkpoint:__ Your output should be similar to the following. 

   <p align="left">
     <img src="images/presentation-output.png" width="50%" alt="Presentation Output" style="border: 1px solid black;" />
     <br>
